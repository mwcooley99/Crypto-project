...
var chartGroupBubble = svgBubble.append("g")
//.attr("id", "chart")
    .attr("transform", `translate(${margin.left + 50}, ${margin.top})`);//+height


// d3.json("/crypto_top_10_bubble").then(function (data) {
//     // alert(error);
...
// Add y-axis to the left side of the display
    ...
    //Create Circles
    // ==============================
    var circlesGroup = chartGroupBubble.selectAll("circle")
        .data(bitcoin)
    ...
    chartGroupBubble.selectAll("circle")
        .append("circle")
        .data(allGroup)
        .enter()
        .attr("cx", 390)
    ...
    chartGroupBubble.selectAll("mylegend")
        .data(allGroup)
        .enter()
        .append("text")
        .style("font-weight", "bold")
